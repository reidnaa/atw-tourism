...
function admin_styles(){
    wp_enqueue_style('loginCSS', get_template_directory_uri() . '/login/css/style.css', false);
    ...
    wp_enqueue_script('vegasjs', get_template_directory_uri() . '/login/js/vegas.min.js', array('jquery'), '1.0', true);
...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('large', 1100, 300, true); // Large Thumbnail
    add_image_size('slider', 1500, 500, true); // Large Thumbnail
    add_image_size('medium', 250, '', true); // Medium Thumbnail
    add_image_size('small', 320, 320, true); // Small Thumbnail
    add_image_size('smaller', 220, 175, true); // Small Thumbnail
    add_image_size('tour', 550, 220, true); // Small Thumbnail
...
function add_fancybox_scripts(){
    wp_enqueue_style('fancyboxcss', get_template_directory_uri() . '/css/fancybox.min.css', array(), '5.0');
    wp_enqueue_script('fancyboxjs', get_template_directory_uri() . '/js/fancybox.min.js', array(), '5.0', true);
}
add_action('wp_enqueue_scripts', 'add_fancybox_scripts');

function add_bxslider_scripts(){
    wp_enqueue_style('bxslidercss', 'https://cdn.jsdelivr.net/bxslider/4.2.12/jquery.bxslider.css', array(), '5.0');
    wp_enqueue_script('bxsliderjs', 'https://cdn.jsdelivr.net/bxslider/4.2.12/jquery.bxslider.min.js', array('jquery'), '5.0', true);
}
